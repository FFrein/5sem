...
int main()
{
	...
	LPCWSTR OS03_02_1 = L"F:\\MyFile\\Univer\\5sem\\OS (Пилинога лк, лр)\\lab3\\Lab3\\Debug\\OS03_02_1.exe";
	LPCWSTR OS03_02_2 = L"F:\\MyFile\\Univer\\5sem\\OS (Пилинога лк, лр)\\lab3\\Lab3\\Debug\\OS03_02_2.exe";
	...
	if (CreateProcess(
		...
		cout << "[OK] OS03_02_1 created.\n";
	else cout << "[ERROR] OS03_02_1 not created.\n";


	if (CreateProcess(OS03_02_2, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &si2, &pi2))
		cout << "[OK] Process OS03_02_2 created.\n\n";
	else cout << "[ERROR] OS03_02_2 not created.\n\n";
